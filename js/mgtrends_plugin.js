...
(function () {
        ...
        createControl: function (id, controlManager) {
            if (id == 'mgtrends_button') {
                ...
                var button = controlManager.createButton('mgtrends_button', {
                    ...
                    image: '../wp-content/plugins/mg-webtrends-graphs/img/mg_webtrends_graph.png',  // path to the button's image
                    onclick: function () {
    ...
    jQuery(function () {
        ...
        var form = jQuery('<div id="mgtrends-form"><table id="mgtrends-table" class="form-table">\
            ...
            <tr>\
				<th><label for="mgtrends-val">Values</label></th>\
				<td><select name="val" id="mgtrends-val"><option value="std">Standard</option><option value="avg">Average</option></select><br />\
					<small>Show average values?</small></td>\
			</tr>\
            <tr>\
				<th><label for="mgtrends-sdate">Start Date</label></th>\
				<td><input type="text" name="sdate" id="mgtrends-sdate" value="" /><br />\
					<small>Enter the starting date of your graph - MM/YYYY (es. 01/2010).</small></td>\
			</tr>\
            <tr>\
				<th><label for="mgtrends-elaps">Duration</label></th>\
				<td><input type="text" name="elaps" id="mgtrends-elaps" value="" /><br />\
					<small>Specify how many months you want to show - (es. 12).</small></td>\
			</tr>\
		</table>\
		<p class="submit">\
